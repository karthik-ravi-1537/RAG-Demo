...
def main():
    ...
    config = RAGConfig(
        ...
        embedding=EmbeddingConfig(model_name="all-MiniLM-L6-v2", normalize=True),  # Local model for demo
        retrieval_top_k=3,
    ...
    try:
        ...
        for i, query in enumerate(demo_queries, 1):
            ...
            sources = list({chunk.source_document for chunk in result.retrieved_chunks})
            if sources:
