...
class ConfigManager:
    ...
    def load_config(self, config_path: str | Path | None = None) -> RAGConfig:
    ...
    def save_config(self, config: RAGConfig, config_path: str | Path | None = None) -> None:
    ...
    @staticmethod
    def create_default_config(config_path: str | Path) -> RAGConfig:
