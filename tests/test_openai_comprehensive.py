...
def has_valid_openai_key():
    ...
    return (api_key and 
            api_key != "test_key_placeholder" and 
    ...
    def test_openai_chat_api_call(self):
        ...
        try:
            ...
            response = client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "user", "content": "Say 'OpenAI test successful' exactly."}
                ],
                max_tokens=10,
                temperature=0
            )
    ...
    def test_rag_with_openai_embeddings(self):
        ...
        try:
            ...
            for query in queries:
                ...
                print(f"✅ Query '{query}': {len(result.retrieved_chunks)} chunks, confidence={result.confidence_score:.3f}")
